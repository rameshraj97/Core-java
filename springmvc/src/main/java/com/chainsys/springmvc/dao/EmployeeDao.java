...
//		int rows ;
		...
		try {
			...
			System.out.println(newemp.getHire_data());
			System.out.println(convertTosqlDate(newemp.getHire_data()));
			ps.setDate(5, convertTosqlDate(newemp.getHire_data()));
...
// for updating all the columns of the table
	public static int updateEmployee(Employee newemp) {
		...
		try {
			...
			// convert java.util.Date to java.sql.date
			ps.setDate(4, convertTosqlDate(newemp.getHire_data()));
