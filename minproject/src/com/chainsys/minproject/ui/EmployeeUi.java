...
public class EmployeeUi {
	 public static void addNewEmployee() {
		...
		public static void getEmployeeById() {
			...
			System.out.println("Employee hired date:"+emp.getHire_data());
		...
		public static void getAllEmployeesDetails() {
			...
			while(empItr.hasNext())
			{
				...
				System.out.println("emp id:"+emp.getEmp_Id()+" "+emp.getFirst_name()+" "+emp.getLast_name()+" "+emp.getJob_id()+" "+emp.getHire_data());
			}
		}
